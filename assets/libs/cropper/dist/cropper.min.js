...
!(function (t, e) {
  ...
  var n = "undefined" != typeof window && void 0 !== window.document,
    ...
    R = "cropstart",
    j = "dblclick",
    A = o ? "pointerdown" : t ? "touchstart" : "mousedown",
    S = o ? "pointermove" : t ? "touchmove" : "mousemove",
    I = o ? "pointerup pointercancel" : t ? "touchend touchcancel" : "mouseup",
    U = "zoom",
    q = "image/jpeg",
  ...
  function Ot(t) {
    ...
    return (
      null !== e &&
      (e[1] !== Bt.protocol || e[2] !== Bt.hostname || e[3] !== Bt.port)
    );
  }
  function Tt(t) {
  ...
  function Et(t) {
    var e = t.rotate,
      ...
      o = t.translateY,
      r = [];
    V(n) && 0 !== n && r.push("translateX(".concat(n, "px)")),
      V(o) && 0 !== o && r.push("translateY(".concat(o, "px)")),
      V(e) && 0 !== e && r.push("rotate(".concat(e, "deg)")),
      V(i) && 1 !== i && r.push("scaleX(".concat(i, ")")),
      V(a) && 1 !== a && r.push("scaleY(".concat(a, ")"));
        ...
        (i.width > i.maxWidth || i.width < i.minWidth) && (i.left = i.oldLeft),
          ...
          dt(
            ...
            ht(
              ...
              Et({ translateX: i.left, translateY: i.top })
            )
          ),
          this.renderImage(t),
        ...
        (i.width > i.maxWidth || i.width < i.minWidth) && (i.left = i.oldLeft),
          ...
          t.movable &&
            ...
            wt(
              this.face,
              g,
              i.width >= e.width && i.height >= e.height ? k : D
            ),
          dt(
            this.cropBox,
            ht(
      ...
      preview: function () {
        ...
        this.cropped &&
          ...
          (dt(
            ...
            ht(
              { width: l, height: d },
              Et(ht({ translateX: -p, translateY: -u }, h))
            )
          ),
          rt(this.previews, function (t) {
            var e = vt(t, f),
    ...
    Rt = {
      bind: function () {
        var t = this.element,
          e = this.options,
          i = this.cropper;
        at(e.cropstart) && Mt(t, R, e.cropstart),
          at(e.cropmove) && Mt(t, M, e.cropmove),
          at(e.cropend) && Mt(t, x, e.cropend),
          at(e.crop) && Mt(t, y, e.crop),
          at(e.zoom) && Mt(t, U, e.zoom),
          Mt(i, A, (this.onCropStart = this.cropStart.bind(this))),
          e.zoomable &&
            e.zoomOnWheel &&
            Mt(i, "wheel", (this.onWheel = this.wheel.bind(this)), {
              passive: !1,
              capture: !0,
            }),
          e.toggleDragModeOnDblclick &&
            Mt(i, j, (this.onDblclick = this.dblclick.bind(this))),
          Mt(t.ownerDocument, S, (this.onCropMove = this.cropMove.bind(this))),
          Mt(t.ownerDocument, I, (this.onCropEnd = this.cropEnd.bind(this))),
          e.responsive &&
            Mt(window, "resize", (this.onResize = this.resize.bind(this)));
      },
      unbind: function () {
        var t = this.element,
          e = this.options,
          i = this.cropper;
        at(e.cropstart) && xt(t, R, e.cropstart),
          at(e.cropmove) && xt(t, M, e.cropmove),
          at(e.cropend) && xt(t, x, e.cropend),
          at(e.crop) && xt(t, y, e.crop),
          at(e.zoom) && xt(t, U, e.zoom),
          xt(i, A, this.onCropStart),
          e.zoomable &&
            e.zoomOnWheel &&
            xt(i, "wheel", this.onWheel, { passive: !1, capture: !0 }),
          e.toggleDragModeOnDblclick && xt(i, j, this.onDblclick),
          xt(t.ownerDocument, S, this.onCropMove),
          xt(t.ownerDocument, I, this.onCropEnd),
          e.responsive && xt(window, "resize", this.onResize);
      },
    },
    jt = {
      resize: function () {
      ...
      cropStart: function (t) {
        ...
        if (
          ...
          t.changedTouches
            ...
            (a =
              1 < Object.keys(o).length && n.zoomable && n.zoomOnTouch
                ? O
                : vt(t.target, g)),
            $.test(a) &&
              !1 !== Ct(this.element, R, { originalEvent: t, action: a }) &&
              (t.preventDefault(),
              (this.action = a),
              (this.cropping = !1),
      ...
      cropMove: function (t) {
        ...
        if (!this.disabled && e) {
          var i = this.pointers;
          t.preventDefault(),
            !1 !== Ct(this.element, M, { originalEvent: t, action: e }) &&
              (t.changedTouches
                ? rt(t.changedTouches, function (t) {
        ...
        if (!this.disabled) {
          ...
          t.changedTouches
            ...
            e &&
              ...
              this.cropping &&
                ((this.cropping = !1),
                mt(this.dragBox, c, this.cropped && this.options.modal)),
    ...
    At = {
      change: function (t) {
        ...
        var x = r[Object.keys(r)[0]],
          M = { x: x.endX - x.startX, y: x.endY - x.startY };
        switch (h) {
          case D:
            (c += M.x), (l += M.y);
            break;
    ...
    St = {
      ...
      enable: function () {
        return (
          this.ready &&
            this.disabled &&
            ((this.disabled = !1), ut(this.cropper, s)),
          this
        );
      },
      disable: function () {
        return (
          this.ready &&
            !this.disabled &&
            ((this.disabled = !0), pt(this.cropper, s)),
          this
        );
      },
      destroy: function () {
      ...
      zoomTo: function (t, e, i) {
        ...
        if (
          ...
          if (
            !1 ===
            Ct(this.element, U, { ratio: t, oldRatio: o / h, originalEvent: i })
          )
            return this;
          if (i) {
            var d = this.pointers,
      ...
      setData: function (t) {
        ...
        if (this.ready && !this.disabled && it(t)) {
          ...
          V(t.x) && (n.left = t.x * r + a.left),
            V(t.y) && (n.top = t.y * r + a.top),
            V(t.width) && (n.width = t.width * r),
            V(t.height) && (n.height = t.height * r),
        ...
        var i = this.canvasData,
          a = (function (t, e, i, a) {
            var n = e.aspectRatio,
              ...
              j = Math.min(X.width, Math.max(R.width, o)),
      ...
      setDragMode: function (t) {
        ...
        if (this.ready && !this.disabled) {
          ...
          (t = n || o ? t : b),
            ...
            mt(i, h, n),
            mt(i, m, o),
            e.cropBoxMovable || (wt(a, g, t), mt(a, h, n), mt(a, m, o));
        }
        return this;
      },
    },
                    ...
                    if (Q.test(t))
                      ...
                      (this.reloading = !0),
                        ...
                        (n.onprogress = function () {
                          n.getResponseHeader("content-type") !== q &&
                            n.abort();
                        }),
                        (n.onload = function () {
                          e.read(n.response);
                ...
                if (1 < a) {
                  this.url = (function (t, e) {
                    for (var i = [], a = new Uint8Array(t); 0 < a.length; )
                      i.push(Ht.apply(null, ot(a.subarray(0, 8192)))),
                        (a = a.subarray(8192));
                    return "data:"
                      .concat(e, ";base64,")
                      .concat(btoa(i.join("")));
              ...
              value: function () {
                if (this.sized && !this.ready) {
                  ...
                  (this.container = a),
                    ...
                    pt(s, X),
                    e.guides ||
                      pt(s.getElementsByClassName("".concat(d, "-dashed")), X),
                    e.center ||
                      pt(s.getElementsByClassName("".concat(d, "-center")), X),
                    e.background && pt(o, "".concat(d, "-bg")),
                    e.highlight || pt(c, u),
                    e.cropBoxMovable && (pt(c, m), wt(c, g, D)),
                    e.cropBoxResizable ||
                      (pt(s.getElementsByClassName("".concat(d, "-line")), X),
                      pt(s.getElementsByClassName("".concat(d, "-point")), X)),
                    this.render(),
                    (this.ready = !0),
                    this.setDragMode(e.dragMode),
                    e.autoCrop && this.crop(),
                    this.setData(e.data),
                    at(e.ready) && Mt(t, "ready", e.ready, { once: !0 }),
                    Ct(t, "ready");
                }
              },
            },
  ...
  if ((ht(It.prototype, Yt, Xt, Rt, jt, At, St), l.fn)) {
    ...
    (l.fn.cropper = function (h) {
      for (
        var t = arguments.length, s = new Array(1 < t ? t - 1 : 0), e = 1;
        e < t;
        e++
      )
        s[e - 1] = arguments[e];
      ...
      (l.fn.cropper.Constructor = It),
      (l.fn.cropper.setDefaults = It.setDefaults),
      (l.fn.cropper.noConflict = function () {
