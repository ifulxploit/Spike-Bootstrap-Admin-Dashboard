  ...
  function j(t, f, o) {
    ...
    function F(e, i, o) {
      ...
      (s[U] = f.cssClasses.valueNormal),
        (s[M] = f.cssClasses.valueLarge),
        (s[k] = f.cssClasses.valueSub);
      var l = [];
      (l[U] = f.cssClasses.markerNormal),
        (l[M] = f.cssClasses.markerLarge),
        (l[k] = f.cssClasses.markerSub);
          ...
          !(function (t, e, r) {
            if ((r = i ? i(e, r) : r) !== N) {
              ...
              (n.className = p(r, f.cssClasses.marker)),
                (n.style[f.style] = t + "%"),
                U < r &&
                  (((n = P(a, !1)).className = p(r, f.cssClasses.value)),
    ...
    function K(t, e, r, n, i, o) {
      return (
        ...
        (r = ft((r = E.getStep(r)))),
        f.isMinMaxEqual && 2 === u.length && (r = 0),
        !(r === t[e] && !o) && r
      );
    }
    function Q(t, e) {
    ...
    return (
      ...
      (l = P(e, f.cssClasses.base)),
      (function (t, e) {
        var r = P(e, f.cssClasses.connects);
        (u = []), (a = []).push(L(r, t[0]));
        for (var n = 0; n < f.handles; n++)
          u.push(V(e, n)), (v[n] = n), a.push(L(r, t[n + 1]));
      })(f.connect, l),
      (p = f.events).fixed ||
        u.forEach(function (t, e) {
      ...
      $("update", function (t, e, a, r, s) {
        v.forEach(function (t) {
          ...
          (r = E.fromStepping(r).toFixed(1)),
            ...
            f.ariaLabel &&
              f.ariaLabel.length &&
              e.children[0].setAttribute("title", f.ariaLabel[t]);
        });
      }),
      (s = {
        destroy: function () {
