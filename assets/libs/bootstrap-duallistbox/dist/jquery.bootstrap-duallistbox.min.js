...
!(function (a, e) {
  ...
  function o(i) {
    i.element.find("option").each(function (e, t) {
      ...
      void 0 === n.data("original-index") &&
        n.data("original-index", i.elementCount++),
  ...
  function r(i, s, l) {
    i.element.find("option").each(function (e, t) {
      var n = a(t);
      n.data("original-index") === s &&
        (n.prop("selected", l),
        l
          ? (n.attr("data-sortindex", i.sortIndex), i.sortIndex++)
    ...
    if (e.settings.infoText) {
      ...
      (l =
        0 == i
          ...
          : c(t === i ? e.settings.infoText : e.settings.infoTextFiltered, [
              t,
              i,
            ])),
        ...
        (l =
          0 === s
            ? e.settings.infoTextEmpty
            : c(n === s ? e.settings.infoText : e.settings.infoTextFiltered, [
                n,
                s,
              ])),
  ...
  function m(i) {
    (i.selectedElements = 0),
      i.elements.select1.empty(),
      i.elements.select2.empty(),
      i.element.find("option").each(function (e, t) {
        var n = a(t);
        n.prop("selected")
          ? (i.selectedElements++,
            i.elements.select2.append(
              n.clone(!0).prop("selected", n.data("_selected"))
            ))
          : i.elements.select1.append(
              n.clone(!0).prop("selected", n.data("_selected"))
            );
      }),
      i.settings.showFilterInputs && (d(i, 1), d(i, 2)),
      h(i);
  }
  function d(s, l) {
    if (s.settings.showFilterInputs) {
      ...
      var o = new RegExp(a.trim(s.elements["filterInput" + l].val()), "gi"),
        ...
        e = s.element;
      (e = 1 === l ? r.not(":selected") : e.find("option:selected")).each(
        function (e, t) {
          var n = a(t),
            i = !0;
          (t.text.match(o) ||
            (s.settings.filterOnValues && n.attr("value").match(o))) &&
            ((i = !1),
            s.elements["select" + l].append(
              n.clone(!0).prop("selected", n.data("_selected"))
            )),
            r.eq(n.data("original-index")).data("filtered" + l, i);
        }
      ),
        h(s);
    }
  ...
  function p(i) {
    "all" !== i.settings.preserveSelectionOnMove || i.settings.moveOnSelect
      ? "moved" !== i.settings.preserveSelectionOnMove ||
        i.settings.moveOnSelect ||
        v(i, 1)
      : (v(i, 1), v(i, 2)),
      i.elements.select1.find("option:selected").each(function (e, t) {
        var n = a(t);
        n.data("filtered1") || r(i, n.data("original-index"), !0);
      }),
      m(i),
      t(i),
      i.settings.sortByInputOrder
        ? f(i.elements.select2)
        : u(i.elements.select2, i);
  }
  function g(i) {
    "all" !== i.settings.preserveSelectionOnMove || i.settings.moveOnSelect
      ? "moved" !== i.settings.preserveSelectionOnMove ||
        ...
        v(i, 2)
      : (v(i, 1), v(i, 2)),
      i.elements.select2.find("option:selected").each(function (e, t) {
        var n = a(t);
        n.data("filtered2") || r(i, n.data("original-index"), !1);
      }),
      m(i),
      t(i),
      u(i.elements.select1, i),
      i.settings.sortByInputOrder && f(i.elements.select2);
  }
  function b(n) {
    n.elements.form.submit(function (e) {
      ...
      !1 === n.settings.eventMoveAllOverride &&
        n.elements.moveAllButton.on("click", function () {
          var i;
          "all" !== (i = n).settings.preserveSelectionOnMove ||
          i.settings.moveOnSelect
            ? "moved" !== i.settings.preserveSelectionOnMove ||
              i.settings.moveOnSelect ||
              v(i, 1)
            ...
            i.element.find("option").each(function (e, t) {
              ...
              n.data("filtered1") ||
                (n.prop("selected", !0),
                n.attr("data-sortindex", i.sortIndex),
                i.sortIndex++);
            }),
            m(i),
            t(i);
  ...
  (l.prototype = {
    ...
    (a.fn[s] = function (n) {
      var t,
        i = arguments;
      return n === e || "object" == typeof n
        ? this.each(function () {
            a(this).is("select")
              ? a.data(this, "plugin_" + s) ||
                a.data(this, "plugin_" + s, new l(this, n))
              : a(this)
                  .find("select")
                  .each(function (e, t) {
        ...
        ? (this.each(function () {
            ...
            e instanceof l &&
              "function" == typeof e[n] &&
              (t = e[n].apply(e, Array.prototype.slice.call(i, 1)));
          }),
          t !== e ? t : this)
        : void 0;
    });
