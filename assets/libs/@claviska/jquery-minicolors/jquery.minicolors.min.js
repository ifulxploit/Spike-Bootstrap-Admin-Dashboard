...
!(function (i) {
  ...
  function n(i, t, o) {
    ...
    t.originalEvent.changedTouches &&
      ...
      i.parent().is(".minicolors-slider-wheel") &&
        ...
        75 < n &&
          ((u = (n = 75) - 75 * Math.cos(r)), (g = 75 - 75 * Math.sin(r))),
        (u = Math.round(u)),
        (g = Math.round(g))),
      (e = { top: g + "px" }),
  ...
  function f(i, t) {
    ...
    if (
      ...
      x(
        i,
        h,
        (d = u.opacity ? parseFloat(1 - M.y / v.height()).toFixed(2) : 1)
      );
  ...
  function d(i, t) {
    ...
    switch (
      (T(i.val())
        ? ((o = j(i.val())),
          (r = F(parseFloat(D(i.val())).toFixed(2), 0, 1)) &&
            i.attr("data-opacity", r))
      ...
      "transparent" === i.val().toLowerCase() &&
        g.find("span").css("opacity", String(0)),
      ...
      case "saturation":
        (c = F((5 * s.h) / 12, 0, 150)),
          (l = F(
            m.height() - Math.ceil(s.b / (100 / m.height())),
            0,
            m.height()
          )),
          b.css({ top: l + "px", left: c + "px" }),
      ...
      case "brightness":
        (c = F((5 * s.h) / 12, 0, 150)),
          (l = F(
            m.height() - Math.ceil(s.s / (100 / m.height())),
            0,
            m.height()
          )),
          b.css({ top: l + "px", left: c + "px" }),
            ...
            return void 0 === t
              ...
              : (C(this).each(function () {
                  "object" == typeof t && null !== t
                    ? (void 0 !== t.opacity &&
                        C(this).attr("data-opacity", F(t.opacity, 0, 1)),
                  ...
                  if (
                    ...
                    for (
                      e.addClass("minicolors-with-swatches"),
                        a = C('<ul class="minicolors-swatches"></ul>').appendTo(
                          e
                        ),
                        c = 0;
                      c < i.swatches.length;
